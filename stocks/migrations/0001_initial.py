    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='stocks.Block', verbose_name='上级板块')),
            ],
        ),
        migrations.CreateModel(
            name='BlockDetail',
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('bkname', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='stocks.Block')),
            ],
        ),
        migrations.CreateModel(
            name='Listing',
