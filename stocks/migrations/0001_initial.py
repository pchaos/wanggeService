    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hvol', models.DecimalField(decimal_places=1, max_digits=10, null=True, verbose_name='持股数量')),
                ('hamount', models.DecimalField(decimal_places=1, max_digits=10, null=True, verbose_name='持股金额')),
                ('hpercent', models.DecimalField(decimal_places=3, max_digits=6, null=True, verbose_name='持股数量占A股百分比')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isactived', models.BooleanField(default=True, verbose_name='是否有效')),
